...
@Service("JpyTargetCurrencyConverter")
public class JpyTargetCurrencyConverter implements CurrencyConverterStrategy {
    private final RuntimeCurrencyConverter runtimeCurrencyConverter;
    private final Integer precision;

    public JpyTargetCurrencyConverter(RuntimeCurrencyConverter runtimeCurrencyConverter, @Value("${currency.inr.precision}") Integer precision) {
    ...
    public String convert(double amount, String from, String to) {
        ...
        try {
            ...
            return String.format("%s %s", result.intValue(), to);
