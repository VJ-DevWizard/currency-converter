...
@Service("EurTargetCurrencyConverter")
public class EurTargetCurrencyConverter implements CurrencyConverterStrategy {

    private final RuntimeCurrencyConverter runtimeCurrencyConverter;
    private final Integer precision;

    public EurTargetCurrencyConverter(RuntimeCurrencyConverter runtimeCurrencyConverter, @Value("${currency.eur.precision}") Integer precision) {
